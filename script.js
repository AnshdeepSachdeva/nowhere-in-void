    ...
    if(rny < 8){
      ...
      if(rn7 == 0){
        if(firstMessage.map == false){
          ...
          let obj = { name: 'Map', image: 'assets/ability-icons/map/map.png', cost: 4, no: 2, activated: false,level :1}
        ...
        if(firstMessage.speed == false){
          ...
          let obj = { name: 'Speed', image: 'assets/ability-icons/speed/speed.png', cost: 3, no: 1, activated: false,level :1}
          inventoryArray.push(obj)
          updateInventory(inventoryArray,player.coinsCount)
        }
        else{
...
function updateInventory(inventoryArray, money) {
  ...
  for (let item of inventoryArray) {
    ...
    if (item.cost > money) {
      if (item.name === 'Map') {
          itemImg.src = 'assets/ability-icons/map/map0.png';
        } else if (item.name === 'Speed') {
          itemImg.src = 'assets/ability-icons/speed/speed0.png';
        }
    }
